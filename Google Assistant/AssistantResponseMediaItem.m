...
@interface AssistantResponseMediaItem ()
...
@implementation AssistantResponseMediaItem
...
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer *)player
    ...
    if ([self.avAudioPlayerDelegate respondsToSelector:@selector(audioPlayerDidFinishPlaying:successfully:)])
        [self.avAudioPlayerDelegate audioPlayerDidFinishPlaying:player successfully:YES];
...
- (void)audioPlayerDecodeErrorDidOccur:(AVAudioPlayer *)player error:(NSError *)error {
    if ([self.avAudioPlayerDelegate respondsToSelector:@selector(audioPlayerDecodeErrorDidOccur:error:)])
        [self.avAudioPlayerDelegate audioPlayerDecodeErrorDidOccur:player error:error];
}
...
{
    AssistantResponseMediaItem *copy = [[[self class] allocWithZone:zone] initWithData:self.audioData
